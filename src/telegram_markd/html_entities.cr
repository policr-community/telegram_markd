  ...
  module Decoder
    ...
    def self.decode_entity(chars)
      if chars[0] == '#'
        ...
        if resolved_entity = TelegramMarkd::HTMLEntities::ENTITIES_MAPPINGS[entities_key]?
    ...
    def self.decode_codepoint(codepoint)
      ...
      if decoded = TelegramMarkd::HTMLEntities::DECODE_MAPPINGS[codepoint]?
        codepoint = decoded
      end
...
module HTML
  extend TelegramMarkd::HTMLEntities::ExtendToHTML
end
